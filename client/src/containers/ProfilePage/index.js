    ...
    if(width >= 800) {
                        ...
                        <div className = "border border-gray-500 bg-white flex flex-row box-content">
                            ...
                            <div className = "flex-grow">
                                    ...
                                    <div className = "">
                                       ...
                                       <TextField
                                        ...
                                        <div className = "px-8 pb-8 flex flex-col">
                                            <div className = "border my-8 border-gray-400 mx-auto"style = {{width: "400px", height: "400px"}}>
                                                <img src="\whitebg.png" />
                                            </div>
                                ...
                                <div className = "ml-auto justify-end bg-amber-100 w-full h-20 border-t border-gray-500 px-8 flex">
                                    <button className=" m-auto text-white text-xl w-2/5 py-2 border font-semibold border-amber-500 bg-amber-400 cursor-pointer hover:opacity-50">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style = {{width:"1000px"}} className = "py-8 m-auto h-full">
                        <div className = "border border-gray-500 bg-white flex flex-row box-content">
                            ...
                            <div className = "flex flex-col flex-grow">
                                ...
                                <div className = "mt-auto justify-end bg-amber-100 w-full h-20 border-t border-gray-500 px-8 flex">
                                    <button className=" m-auto text-white text-xl w-2/5 py-2 border font-semibold border-amber-500 bg-amber-400 cursor-pointer hover:opacity-50">Save</button>
                                </div>
                            </div>
                        </div>
        ...
        if(pageState) {
            if(pageState == "profile") {
                return(
                    <div className = " ">
                        <div style = {{width:"w-full"}} className = "mx-auto h-full">
                        <div className = " bg-white flex flex-col box-content">
                            <div className = "shrink-0 border-r bg-amber-200 border-gray-500 py-8">
                                <Avatar
                                    alt="Remy Sharp"
                                    src="\android-chrome-512x512.png"
                                    sx={{ width: 120, height: 120, margin: "auto" }}
                            ...
                            <div className = "flex-grow">
                                <div className = "  bg-amber-100 border-b border-gray-500 p-8 text-center">
                                    ...
                                    <div className = "">
                                       ...
                                       <TextField
                                        ...
                                        <div className = "px-8 pb-8 flex flex-col">
                                            <div className = "border my-8 border-gray-400"style = {{width: "full", height: "350px"}}>
                                                <img src="\whitebg.png" />
                                            </div>
                                            <label htmlFor="myImage" className="mx-auto text-white btn p-3 border font-semibold border-amber-500 bg-amber-400 cursor-pointer hover:opacity-50">Select Image</label>
                                            <input
                                                className = "invisible"
                                                type="file"
                                                id="myImage"
                                ...
                                <div className = "ml-auto justify-end bg-amber-100 w-full h-20 border-t border-gray-500 px-8 flex">
                                    <button className=" m-auto text-white text-xl w-3/4 py-2 border font-semibold border-amber-500 bg-amber-400 cursor-pointer hover:opacity-50">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                return(
                    <div style = {{width:"100%"}} className = " m-auto  h-full">
                        <div className = " bg-white flex flex-col box-content">
                            <div className = "shrink-0 border-r bg-amber-200  py-8 w-full">
                                <Avatar
                                    alt="Remy Sharp"
                                    src="\android-chrome-512x512.png"
                                    sx={{ width: 120, height: 120, margin: "auto" }}
                ...
                return(
                    <div style = {{width:"100%"}} className = " m-auto  h-full">
                        <div className = " bg-white flex flex-col box-content">
                            <div className = "shrink-0 border-r bg-amber-200  py-8 ">
                                <Avatar
                                    alt="Remy Sharp"
                                    src="\android-chrome-512x512.png"
                                    sx={{ width: 120, height: 120, margin: "auto" }}
